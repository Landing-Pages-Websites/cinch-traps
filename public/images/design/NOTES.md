...
- STEP FILENAME CONTRACT (placement is by file name): how-step1-mound.png = Step 1 (find the active tunnel), how-step2-trap-set.png = Step 2 (open it / trap set in opened tunnel), how-step3-trap.png = Step 3 (set two traps facing opposite directions), how-step4-trap-sprung.png = Step 4 (done — check the flag / sprung trap). Names carry the step number — never place by guess.
